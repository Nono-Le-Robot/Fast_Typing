  ...
  if (frozen) {
    ...
    frozenEnemies.push(
      new Sprite({
        ...
        imageSrc: "https://sannier-renaud.fr/type-tower/assets/ice.png",
    ...
    slowProjectiles.push(
      new Sprite({
        ...
        imageSrc: "https://sannier-renaud.fr/type-tower/assets/frozenLaser.png",
...
const shieldAnimation = () => {
  shieldsAnimation.push(
    new Sprite({
      ...
      imageSrc: "https://sannier-renaud.fr/type-tower/assets/shield.png",
...
const explosionEnemyAnimation = () => {
  explosionsEnemy.push(
    new Sprite({
      ...
      imageSrc:
        "https://sannier-renaud.fr/type-tower/assets/explosionEnemy.png",
...
const explosionEnemyPlayerHitAnimation = (enemy) => {
  explosionsPlayerHit.push(
    new Sprite({
      ...
      imageSrc:
        "https://sannier-renaud.fr/type-tower/assets/explosionPlayerHit.png",
...
const explosionGameOverAnimation = (player, offsetExplosion) => {
  ...
  explosionsGameOver.push(
    new Sprite({
      ...
      imageSrc:
        "https://sannier-renaud.fr/type-tower/assets/explosionGameOver.png",
  ...
  setTimeout(() => {
    explosionsGameOver.push(
      new Sprite({
        ...
        imageSrc:
          "https://sannier-renaud.fr/type-tower/assets/explosionGameOver2.png",
        framesX: { max: 11, hold: 5 },
        framesY: { max: 1, hold: 5 },
