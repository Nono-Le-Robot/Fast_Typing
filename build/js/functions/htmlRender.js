...
const htmlRender = () => {
  ...
  elementHearts.innerHTML =
    `<img id="icon-heart" src='https://sannier-renaud.fr/type-tower/assets/icons/heart.png' />` +
    hearts;
  ...
  elementCoins.innerHTML =
    `<img id="icon-coin" src='https://sannier-renaud.fr/type-tower/assets/icons/coin.png' />` +
    coins.toFixed(2);
