const fireAudio = new Audio(
  "https://sannier-renaud.fr/type-tower/assets/sounds/fire.mp3"
);
const failAudio = new Audio(
  "https://sannier-renaud.fr/type-tower/assets/sounds/fail.mp3"
);
const explosionEnemyAudio = new Audio(
  "https://sannier-renaud.fr/type-tower/assets/sounds/explosionEnemy.mp3"
);
const explosionsPlayerHitAudio = new Audio(
  "https://sannier-renaud.fr/type-tower/assets/sounds/explosionEnemy.mp3"
);
const explosionsGameOverAudio = new Audio(
  "https://sannier-renaud.fr/type-tower/assets/sounds/explosionGameOver.mp3"
);
const frozenBlastAudio = new Audio(
  "https://sannier-renaud.fr/type-tower/assets/sounds/frozenBlast.mp3"
);
const failCoinAudio = new Audio(
  "https://sannier-renaud.fr/type-tower/assets/sounds/failCoin.mp3"
);
const multiplierWinAudio = new Audio(
  "https://sannier-renaud.fr/type-tower/assets/sounds/multiplierWin.mp3"
);
const multiplierFailAudio = new Audio(
  "https://sannier-renaud.fr/type-tower/assets/sounds/multiplierFail.mp3"
);
const wrongTimingAudio = new Audio(
  "https://sannier-renaud.fr/type-tower/assets/sounds/wrongTiming.mp3"
);
