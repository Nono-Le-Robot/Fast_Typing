  ...
  setTimeout(() => {
    ...
    if (Math.abs(newPositionX - lastPositionX) > moveTreshold) {
      if (newPositionX < lastPositionX) {
        enemy.image.src =
          "https://sannier-renaud.fr/type-tower/assets/enemy_level_1_left.png";
      } else if (newPositionX > lastPositionX) {
        enemy.image.src =
          "https://sannier-renaud.fr/type-tower/assets/enemy_level_1_right.png";
      }
    }
    if (Math.abs(newPositionY - lastPositionY) > moveTreshold) {
      if (newPositionY < lastPositionY) {
        enemy.image.src =
          "https://sannier-renaud.fr/type-tower/assets/enemy_level_1_up.png";
      } else if (newPositionY > lastPositionY) {
        enemy.image.src =
          "https://sannier-renaud.fr/type-tower/assets/enemy_level_1_down.png";
      }
    }
