...
const setGameOver = (enemy) => {
  ...
  if (loggedUsername) {
    axios
      .post("https://sannier-renaud.fr/portfolio/type-tower/api/data/my-data", {
      ...
      .then((response) => {
        ...
        axios.post(
          "https://sannier-renaud.fr/portfolio/type-tower/api/data/update-data",
          {
            username: loggedUsername,
            score: newScore,
            round: wave,
  ...
  document.getElementById("reload-icon-recap").addEventListener("click", () => {
    ...
    if (logged) {
      window.location.href =
        "https://sannier-renaud.fr/type-tower/loggedMenu.html";
    }
    if (!logged) {
      window.location.href =
        "https://sannier-renaud.fr/type-tower/unloggedMenu.html";
    }
  });
};
      ...
      .addEventListener("click", (e) => {
        ...
        if (!fullscreenSet) {
          ...
          document.getElementById("fullscreen-icon").src =
            "https://sannier-renaud.fr/type-tower/assets/icons/no-fullscreen.png";
        } else {
          exitFullScreen(document.documentElement);
          fullscreenSet = false;
          document.getElementById("fullscreen-icon").src =
            "https://sannier-renaud.fr/type-tower/assets/icons/fullscreen.png";
        }
      });
