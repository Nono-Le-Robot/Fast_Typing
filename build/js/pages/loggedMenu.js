...
playBtn.addEventListener("click", () => {
  window.location.href = "https://sannier-renaud.fr/type-tower/game.html";
});

helpBtn.addEventListener("click", () => {
  window.location.href = "https://sannier-renaud.fr/type-tower/help.html";
});

statsBtn.addEventListener("click", () => {
  window.location.href = "https://sannier-renaud.fr/type-tower/myStats.html";
});
...
backIcon.addEventListener("click", () => {
  window.location.href = "https://sannier-renaud.fr/type-tower/index.html";
});
axios
  .get(
    "https://sannier-renaud.fr/portfolio/type-tower/api/data/get-leaderboard-score"
  )
...
axios
  .get(
    "https://sannier-renaud.fr/portfolio/type-tower/api/data/get-leaderboard-accuracy"
  )
  .then(function (response) {
    console.log(response);
    response.data.forEach((element, index) => {
...
axios
  .get(
    "https://sannier-renaud.fr/portfolio/type-tower/api/data/get-leaderboard-speed"
  )
  .then(function (response) {
    console.log(response);
    response.data.forEach((element, index) => {
